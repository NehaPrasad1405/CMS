...
<body>
    ...
    <h1>All Tags</h1>
    <a href="/tags/create"> <button class="btn btn-info" style="margin-left:700px">Add new Tag</button></a>
...
<tr>
    ...
    <a href="tags/{{$tag->id}}/edit" ><button class="btn btn-warning" style="margin-left:50px">Edit</button></a>
